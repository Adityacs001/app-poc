...
import { GETVACANCYTEMPLATEDETAILS } from "../../lib/apiendpointconstants";
import { useridentity } from "../../lib/commontypes";

const getvacancytemplatedetails = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETVACANCYTEMPLATEDETAILS}?rid=${rid}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getvacancytemplatedetails);
