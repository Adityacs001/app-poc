...
import { GETEXPATBYID } from "../../lib/apiendpointconstants";
import { useridentity } from "../../lib/commontypes";

const getexpatbyid = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETEXPATBYID}?rid=${rid}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getexpatbyid);
