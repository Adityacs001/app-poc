...
import { GETJOBDESCRIPTIONATTACHMENT } from "../../lib/apiendpointconstants";
import { useridentity } from "../../lib/commontypes";

const getjobdescriptionattachment = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETJOBDESCRIPTIONATTACHMENT}?rid=${rid}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getjobdescriptionattachment);
