...
import { GETEXPATDETAILS } from "../../lib/apiendpointconstants";
import { useridentity } from "../../lib/commontypes";

const getexpatdetails = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETEXPATDETAILS}?rid=${rid}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getexpatdetails);
