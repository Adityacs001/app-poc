...
import { GETOFFERSETUP } from "../../lib/apiendpointconstants";
import { useridentity } from "../../lib/commontypes";

const getoffersetup = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETOFFERSETUP}?rid=${rid}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getoffersetup);
