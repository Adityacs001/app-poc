...
import { GETUNLISTEDJOBSEEKERS } from "../../lib/apiendpointconstants";
...
const getunlistedjobseekers = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETUNLISTEDJOBSEEKERS}?keyword=${keyword}&currentpage=${currentpage}&pagesize=${pagesize}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getunlistedjobseekers);
