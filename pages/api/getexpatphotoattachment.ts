...
import { GETEXPATPHOTOATTACHMENT } from "../../lib/apiendpointconstants";
import { useridentity } from "../../lib/commontypes";

const getexpatphotoattachment = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETEXPATPHOTOATTACHMENT}?rid=${rid}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getexpatphotoattachment);
