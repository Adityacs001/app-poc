...
import { GETINTERVIEWSETUP } from "../../lib/apiendpointconstants";
import { useridentity } from "../../lib/commontypes";

const getInterviewsetup = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETINTERVIEWSETUP}?rid=${rid}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getInterviewsetup);
