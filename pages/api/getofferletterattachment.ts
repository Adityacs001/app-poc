...
import { GETOFFERLETTERATTACHMENT } from "../../lib/apiendpointconstants";
import { useridentity } from "../../lib/commontypes";

const getofferletterattachment = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETOFFERLETTERATTACHMENT}?rid=${rid}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getofferletterattachment);
