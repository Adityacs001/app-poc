...
import { GETVACANCYTEMPLATEBYID } from "../../lib/apiendpointconstants";
import { useridentity } from "../../lib/commontypes";

const getvacancytemplatebyid = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETVACANCYTEMPLATEBYID}?rid=${rid}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getvacancytemplatebyid);
