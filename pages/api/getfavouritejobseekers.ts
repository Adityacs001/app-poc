...
import { GETFAVOURITEJOBSEEKERS } from "../../lib/apiendpointconstants";
...
const getfavouritejobseekers = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETFAVOURITEJOBSEEKERS}?keyword=${keyword}&currentpage=${currentpage}&pagesize=${pagesize}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getfavouritejobseekers);
