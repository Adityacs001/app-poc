...
import { GETDASHBOARD } from "../../lib/apiendpointconstants";
...
const getdashboard = async (
  ...
  if (req.method === "GET") {
    let param: string = `${GETDASHBOARD}?clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getdashboard);
