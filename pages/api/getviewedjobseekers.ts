...
import { GETVIEWEDJOBSEEKERS } from "../../lib/apiendpointconstants";
...
const getviewedjobseekers = async (
  ...
  if (req.method === "GET") {
    ...
    let param: string = `${GETVIEWEDJOBSEEKERS}?keyword=${keyword}&currentpage=${currentpage}&pagesize=${pagesize}&clientid=${user.clientid}&contactid=${user.contactid}`;
...
export default enhancewithsession(getviewedjobseekers);
