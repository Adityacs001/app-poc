...
const ExpatManager = ({ user }) => {
  ...
  const {
    ...
    {
      enabled: !!user && selectedvacancy != undefined,
      refetchOnWindowFocus: false,
    },
  );
  ...
  return (
    <React.Fragment>
              ...
              <div className="hidden sm:block">
                <nav className="-mb-px flex space-x-8">
                  ...
                  >
                    ...
                    <span className="inline-block px-1">Nomination</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="inline-block px-1">Interview</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="inline-block px-1">Offer</span>
                  </a>
                  ...
                  >
                    ...
                    <span className="inline-block px-1">Hired</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="inline-block px-1">Rejected</span>
                  </a>
                </nav>
              </div>
            </div>
      ...
      {showdetail && (
        <div className="z-20 absolute inset-0 overflow-hidden h-screen">
