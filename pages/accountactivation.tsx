...
const AccountactivationPage = (props) => {
  ...
  return (
    <div className="flex flex-col min-h-screen ">
      <div className=" border-b border-gray-200 px-4 py-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8 sm:flex-wrap bg-white text-gray-700">
        <div className="mx-auto flex flex-col space-y-2 items-start">
          <h1 className=" text-lg font-semibold">
            Please reset your current password to start accessing your account.
          </h1>
          <button
            onClick={(e) => handleLogout(e)}
            className="font-medium text-indigo-600 hover:text-indigo-500 focus:outline-none focus:underline hover:underline transition ease-in-out duration-150"
          >
            Logout
          </button>
        </div>
...
AccountactivationPage.getLayout = getLayout;
